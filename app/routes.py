...
def index(): 
    ...
    if form.validate_on_submit():
        ...
        return redirect(url_for('index')) # always respond to a POST request generated by a web form submission with a redirect
...
def explore():
    ...
    return render_template('index.html', title='Explore', posts=posts.items) # I use the 'index' ready-made template, but don't wanna have a form to write blog posts, so I did not include the "form" argument 
